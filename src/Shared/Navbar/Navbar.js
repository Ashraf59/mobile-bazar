...
const Navbar = () => {
  ...
  const handleLogOut = () => {
    ...
    <li className='font-bold text-xl hover:text-rose-500'><Link to = '/allcatagory'>All Categories</Link></li>
    ...
    return (
        ...
        <div className="navbar-start">
          ...
          <Link to ='/' className="font-extrabold text-transparent text-4xl bg-clip-text bg-gradient-to-r from-rose-500 to-purple-500 hover:from-green-500 hover:to-blue-500 text-white"> Mobile Bazar
          </Link>
        </div>
